...
export const classService = new ClassService(aiProvider);
export const raceService = new RaceService(aiProvider);
export const npcService = new NpcService(aiProvider);
